...
This page is a draft reference map for LakeEnsemblR.WQ functions. It can be used as a starting point for a pkgdown reference index.
...
If you use _pkgdown.yml, map the reference sections to the groups above so setup, execution, extraction, and metrics are clearly separated for users.

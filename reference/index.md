...
- [`create_input_tables()`](https://tubabucak.github.io/LakeEnsemblR.WQ/reference/create_input_tables.md)
...
- [`set_coupling()`](https://tubabucak.github.io/LakeEnsemblR.WQ/reference/set_coupling.md)
  : Set coupling settings for each model
- [`disable_module()`](https://tubabucak.github.io/LakeEnsemblR.WQ/reference/disable_module.md)
  : Disables a module
...
- [`export_all_stats()`](https://tubabucak.github.io/LakeEnsemblR.WQ/reference/integrate_depths.md)
...
- [`plot_model_vs_obs_wq()`](https://tubabucak.github.io/LakeEnsemblR.WQ/reference/plot_model_vs_obs_wq.md)
  : Plot one or more models' output against observed data at matching
  depths
...
- [`visualise_dictionary()`](https://tubabucak.github.io/LakeEnsemblR.WQ/reference/visualise_dictionary.md)
  [`visualize_dictionary()`](https://tubabucak.github.io/LakeEnsemblR.WQ/reference/visualise_dictionary.md)
  : Visualise LakeEnsemblR.WQ dictionary
- [`convert_ler_to_lerwq()`](https://tubabucak.github.io/LakeEnsemblR.WQ/reference/convert_ler_to_lerwq.md)
